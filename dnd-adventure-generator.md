...
- **Faction priorities & timing** — for multi-faction fights or pressure-valve encounters: a bulleted list of trigger conditions, faction priorities, and the resulting major loose ends.
